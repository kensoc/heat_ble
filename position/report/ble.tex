...
In the demo, our design achieved resonable precision until we are two meters from the boundary of the target region.
...
Multipath and other interferences may be lower, which leads to better calibration and operation result than we anticipated.
...
However, the Bluetooth LE API of both Android and Arduino are underdocumented.
...
Both our experiment results and previous works suggests that using Bluetooth LE signal strength for precise positioning is likely infeasible.
