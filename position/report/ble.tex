...
However, as we noticed that the signal strengths significantly varied, we planned to do a lot of calibration. The RSSI value can estimate distance that might be basic near or far result. 
